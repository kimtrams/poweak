...
class Node():
    def __init__(self):
        ...
        self.node_list = ['172.20.10.13 5000', '172.20.10.14 5001', '172.20.10.5 5002', '172.20.10.6 5003']
        self.ip_list = ['172.20.10.13', '172.20.10.14', '172.20.10.5', '172.20.10.6']
